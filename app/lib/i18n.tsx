...
const en: Dict = {
  ...
  'login.subtitle.signin': 'Use your email and password.',
  ...
  'login.to_signup': "Don't have an account? Create one",
  'login.to_signin': 'Already have an account? Sign in',
  'login.to_forgot': 'Forgot your password?',
  ...
  'welcome.body':
    'A ranking of 3D-print opportunities: products with rising buying demand while the market is still open. Create a free account to see it.',
...
const pt: Dict = {
  ...
  'login.to_signup': 'Ainda não tens conta? Cria uma',
  'login.to_signin': 'Já tens conta? Entra',
  'login.to_forgot': 'Esqueceste-te da senha?',
  ...
  'welcome.body':
    'Um ranking de oportunidades em impressão 3D: produtos com procura de compra a subir enquanto o mercado ainda está aberto. Cria uma conta grátis para o veres.',
...
const es: Dict = {
  ...
  'login.subtitle.signin': 'Usa tu correo y contraseña.',
  ...
  'login.to_signup': '¿Aún no tienes cuenta? Crea una',
  'login.to_signin': '¿Ya tienes cuenta? Entra',
  'login.to_forgot': '¿Olvidaste tu contraseña?',
  ...
  'welcome.body':
    'Un ranking de oportunidades en impresión 3D: productos con demanda de compra en alza mientras el mercado sigue abierto. Crea una cuenta gratis para verlo.',
