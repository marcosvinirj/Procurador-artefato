...
const en: Dict = {
  ...
  'showcase.title_one': 'Top listing',
  'showcase.title_many': 'Selling now',
  'showcase.search': 'See this search',
  'showcase.view': 'View listing',
  'showcase.no_photo': 'Photo on its way — updated daily.',
  'showcase.empty': 'No listings collected yet. They update every day.',
  'showcase.upsell_free': 'Pro shows the listing link and the exact search behind these numbers.',
...
const pt: Dict = {
  ...
  'plan.name.pro': 'Pro',
  'plan.name.premium': 'Premium',
  'showcase.title_one': 'Anúncio líder',
  'showcase.title_many': 'A vender agora',
  'showcase.search': 'Ver esta pesquisa',
  'showcase.view': 'Ver anúncio',
  'showcase.no_photo': 'Foto a caminho — atualiza todos os dias.',
  'showcase.empty': 'Ainda sem anúncios recolhidos. Atualizam todos os dias.',
  'showcase.upsell_free': 'No Pro vês o link do anúncio e a pesquisa exata por trás destes números.',
...
const es: Dict = {
  ...
  'plan.name.pro': 'Pro',
  'plan.name.premium': 'Premium',
  'showcase.title_one': 'Anuncio líder',
  'showcase.title_many': 'Vendiéndose ahora',
  'showcase.search': 'Ver esta búsqueda',
  'showcase.view': 'Ver anuncio',
  'showcase.no_photo': 'Foto en camino — se actualiza cada día.',
  'showcase.empty': 'Aún no hay anuncios recogidos. Se actualizan cada día.',
  'showcase.upsell_free':
    'En Pro ves el enlace del anuncio y la búsqueda exacta detrás de estos números.',
