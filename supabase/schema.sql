...
insert into models (name, category, keyword, synonyms) values
  ...
  ('Dinossauro Articulado',       'brinquedos', 'articulated dinosaur',  '{"flexi dinosaur","print in place dinosaur"}'),
  ('Borboleta Articulada',        'brinquedos', 'articulated butterfly', '{"flexi butterfly"}'),
  ('Giroscopio de Secretaria',    'brinquedos', 'desk gyroscope',        '{"fidget gyroscope","spinning top toy"}'),
  ...
  ('Torre de Dados',              'decoracao',  'dice tower',            '{"dnd dice tower","tabletop dice tower"}'),
  ('Vaso Suculentas Geometrico',  'decoracao',  'geometric planter',     '{"succulent pot","low poly planter"}'),
  ('Moinho de Vento Decorativo',  'decoracao',  'wind spinner',          '{"kinetic wind spinner","garden spinner"}'),
  ...
  ('Porta-Sabonete',              'utilidades', 'soap dish',             '{"soap holder","self draining soap dish"}'),
  ('Organizador de Gaveta',       'utilidades', 'drawer organizer',      '{"drawer divider","drawer tray"}'),
  ('Suporte de Especiarias',      'utilidades', 'spice rack',            '{"spice organizer","spice shelf"}'),
  ...
  ('Suporte de Tablet',           'gadgets',    'tablet stand',          '{"ipad stand","tablet holder"}'),
  ('Tapa Webcam',                 'gadgets',    'webcam cover',          '{"camera privacy cover","laptop camera cover"}'),
  ('Elevador de Monitor',         'gadgets',    'monitor stand',         '{"monitor riser","monitor stand riser"}')
